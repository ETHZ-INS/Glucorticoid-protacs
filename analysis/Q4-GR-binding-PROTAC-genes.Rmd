...
png(file="../docs/assets/Q4_2_kh_peak_tracks.png", width=12,height=7,units="in",res=1200)
...
mygenes.transcripts <-  subset(transcripts(ensdb, columns=c("tx_id", "tx_name","gene_id","gene_name")), gene_name %in% kh.protac.sig$Gene)
...
png(file="../docs/assets/Q4_3_kh_all_txs.png", width=12,height=7,units="in",res=1200)
...
png(file="../docs/assets/Q4_4_kh_unique_gene_tss.png", width=12,height=7,units="in",res=1200)
