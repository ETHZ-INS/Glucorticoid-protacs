...
ggsave(filename="../data/00_paper_figures/6d2c.pdf", width = 14, height=5)
```
...
ggsave(filename="../data/00_paper_figures/6c2a.pdf", width = 14, height=5)
```
...
ggsave(filename="../data/00_paper_figures/6c2c.pdf", width = 14, height=5)
```
