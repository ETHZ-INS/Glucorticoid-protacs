...
plot_logFCs <- function(rownames_subset, title){
  # cort
...
rnames_flipped_cort <- merged216 %>% filter(cort_flipped == TRUE) %>% pull(rowname)
rnames_flipped_mif <- merged216 %>% filter(MIF_flipped == TRUE) %>% pull(rowname)
rnames_flipped_kh <- merged216 %>% filter(KH_flipped == TRUE) %>% pull(rowname)

plt_flipped_cort <- plot_logFCs(rnames_flipped_cort, "Genes flipped by cort")
plt_flipped_mif <- plot_logFCs(rnames_flipped_mif, "Genes flipped by MIF")
plt_flipped_kh <- plot_logFCs(rnames_flipped_kh, "Genes flipped by KH")
...
plt_flipped_cort_only <- plot_logFCs(rnames_flipped_cort_only, "Genes flipped by cort only")
plt_flipped_mif_only <- plot_logFCs(rnames_flipped_mif_only, "Genes flipped by MIF only")
plt_flipped_kh_only <- plot_logFCs(rnames_flipped_kh_only, "Genes flipped by KH only")
...
rnames_flipped_cort <- merged162 %>% filter(cort_flipped == TRUE) %>% pull(rowname)
rnames_flipped_mif <- merged162 %>% filter(MIF_flipped == TRUE) %>% pull(rowname)
rnames_flipped_kh <- merged162 %>% filter(KH_flipped == TRUE) %>% pull(rowname)
