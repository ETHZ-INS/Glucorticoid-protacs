...
se$condition <- factor(se$condition, levels=c("Control","12hDEX"))
# is equivalent to:
...
tracks <- list("C2"="../data/single_replicate_peaks/control/Chip_GR_control_s2.bigWig",
               ...
               "t2_1"="../data/single_replicate_peaks/dex2h/Chip_GR_12hDex_s1.bigWig",
               "t2_2"="../data/single_replicate_peaks/dex2h/Chip_GR_12hDex_s2.bigWig",
               "t2_3"="../data/single_replicate_peaks/dex2h/Chip_GR_12hDex_s3.bigWig",
...
c <- bwNormFactors(tracks)
sm2 <- rescaleSignalMatrices(m, nf)
