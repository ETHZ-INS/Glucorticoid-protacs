...
```{r}
ggsave(file="../docs/assets/Q2_1_pvalue_dist_2h.png", plt_value)
ggsave(file="../docs/assets/Q2_2_logfc_dist_2h.png", plt_logfc)
ggsave(file="../docs/assets/Q2_3_mahshid_reddy_2h.png", combined_plot, width=12, height=8)
```
...
ggsave(filename="../docs/assets/Q2_4_boxplots_2h.png", boxplot, width=14, height=10, unit="in")
```


# Relationship between a logFC and the closest GR peak

```{r logFC vs GR peak, fig.width=14, fig.height=18}
...
ggsave(filename="../docs/assets/Q2_5_TSS_distances_2h.png", TSS_distances)
```
...
ggsave(filename="../docs/assets/Q2_5_TSS_distances_xlim2500_2h.png", TSS_distances_xlim)
ggsave(filename="../docs/00_paper_figures/6b_2h.png", TSS_distances_xlim)
```
...
ggsave(filename="../docs/assets/Q2_6_boxplots_class_2h.png", group_image2, width=14, height=10, unit="in")
```
