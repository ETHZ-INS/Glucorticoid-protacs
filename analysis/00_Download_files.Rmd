...
```{r, eval=FALSE}
# bigwig 0.5h DEX 
download.file("https://www.encodeproject.org/files/ENCFF901SYU/@@download/ENCFF901SYU.bigWig", "../data/reddy_bed_DEX30min_r123.bigWig")
...
dir.create("../data/single_replicate_peaks")
dir.create("../data/single_replicate_peaks/control")
dir.create("../data/single_replicate_peaks/dex12h")
...
```{r}
download.file("https://github.com/ElisaSalviato/3D-ETG/blob/main/Results/Formatted_Candidate_ETG_20200305_TAD10Kb.tsv.gz?raw=true", "../data/enhancerTargets.tsv.gz")
```
