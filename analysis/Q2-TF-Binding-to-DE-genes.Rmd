...
```{r, message=FALSE}
ggsave(file="../docs/assets/Q2_1_pvalue_dist.pdf", plt_value)
ggsave(file="../docs/assets/Q2_2_logfc_dist.pdf", plt_logfc)
ggsave(file="../docs/assets/Q2_3_mahshid_reddy.pdf", combined_plot, width=12, height=8)
```
...
ggsave(filename="../docs/assets/Q2_4_boxplots.pdf", boxplot, width=14, height=10, unit="in")
```
...
ggsave(filename="../docs/assets/Q2_5_TSS_distances.pdf", TSS_distances)
```
...
ggsave(filename="../docs/assets/Q2_5_TSS_distances_xlim2500.pdf", TSS_distances_xlim)
ggsave(filename="../docs/00_paper_figures/6b_12h.pdf", TSS_distances_xlim)
```


```{r boxplots based on class, fig.width=14, fig.height=10, message=FALSE}
...
ggsave(filename="../docs/assets/Q2_6_boxplots_class.pdf", group_image2, width=14, height=10, unit="in")
```
