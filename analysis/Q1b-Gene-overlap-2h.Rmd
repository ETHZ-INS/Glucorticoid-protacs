...
venn.diagram(
  ...
  filename = '../docs/assets/1_venn_diagram_2h.png',
  imagetype="png",
  output=FALSE,
...
```
```{bash, engine.opts='-l'}
cp ../docs/assets/1_venn_diagram_2h.png ../docs/00_paper_figures/6b_venn.png
```
...
ggsave(file="../docs/assets/2_logFC_Mahshid_Reddy_2h.png", plot_lfc)
```
